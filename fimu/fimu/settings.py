# -*- coding: utf-8 -*-
# Django settings for the fimu project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ionyweb_fimu',                      # Or path to database file if using sqlite3.
        'USER': 'modulo',                      # Not used with sqlite3.
        'PASSWORD': 'modulo',                  # Not used with sqlite3.
